import{u as h,w,y as m,i as f,a as v,x as b}from"./CheckoutPage-BbtuafAx.js";import{r as u,c as g}from"./if-defined-JNa6PzdC.js";const e=h({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),s={state:e,subscribe(o){return m(e,()=>o(e))},subscribeKey(o,t){return w(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},x=f`
  :host {
    pointer-events: none;
  }
